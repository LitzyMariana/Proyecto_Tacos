...
public class FormPedidoM extends Stage{
    ...
    public FormPedidoM(TableView<PedidoDAO> tbvPedido, PedidoDAO obj, int bandera)
    {
        if( obj != null) {
            objP = obj;
        }
    ...
    private void CrearGUI(int bandera)
    {
        ...
        escena.getStylesheets().add("sample/Estilos/FormstylePM.css");
    }
